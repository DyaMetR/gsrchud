...
if CLIENT then
  ...
  local spriteData = { -- Sprite data
    ...
    ["flash_full"] = {x = 160, y = 24, w = 32, h = 31, file = file},
    ["flash_empty"] = {x = 112, y = 24, w = 32, h = 31, file = file},
    ["flash_beam"] = {x = 144, y = 24, w = 16, h = 31, file = file},
    ...
    ["dmg_drown"] = {x = 64, y = 128, w = 64, h = 64, file = file_hazard},
