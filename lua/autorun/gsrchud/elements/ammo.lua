...
if CLIENT then
  ...
  local function Ammo()
    ...
    if localPlayer.GetActiveWeapon == nil or not IsValid(localPlayer:GetActiveWeapon()) or (localPlayer:GetActiveWeapon():GetPrimaryAmmoType() <= -1 and localPlayer:GetActiveWeapon():GetSecondaryAmmoType() <= -1) then return; end
